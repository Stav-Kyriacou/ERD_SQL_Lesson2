...
INSERT INTO RATING0510
  (ratingcode, shortdesc, longdesc)
VALUES
...
INSERT INTO MOVIE0510
  (MOVIENO, TITLE, RELYEAR, RUNTIME, RATINGCODE, COLOURCODE, TMDB_SCORE, TMDB_VOTES, TMDB_ID)
VALUES
...
WHERE (R.RATINGCODE = 'MA' AND M.RUNTIME BETWEEN 100 and 102
  OR R.RATINGCODE = 'G' AND M.RUNTIME <= 90
  OR R.RATINGCODE = 'PG' AND M.RUNTIME BETWEEN 120 and 125
  OR R.RATINGCODE = 'M' AND M.RUNTIME >= 180)
  AND (M.TMDB_SCORE BETWEEN 6.5 AND 7.5)

ORDER BY M.MOVIENO ASC;

--Task 12
SELECT M.MOVIENO, M.TITLE, M.RUNTIME, M.TMDB_SCORE, R.LONGDESC, M.TMDB_ID
FROM MOVIE0510 M
...
WHERE NOT UPPER(M.TITLE) LIKE '%A%'
AND NOT UPPER(M.TITLE) LIKE '%E%'
AND NOT UPPER(M.TITLE) LIKE '%I%'
...
--Task 15 c)
SELECT M.MOVIENO, M.TITLE, M.RELYEAR, M.RUNTIME, M.RATINGCODE
FROM MOVIE0510 M
